...
function addel(elem) {
  if (UserDetail === null) {
    ...
    localStorage.setItem("ATC", JSON.stringify(mainarr));
    let cartData = JSON.parse(localStorage.getItem("ATC"))
...
function myfunc(elem) {
  localStorage.setItem("obj", JSON.stringify(elem));
